...
namespace LocalHistoryNPPPlugin
{
    ...
    {
        #region " Fields "
        internal const string PluginName = "Local History";
        ...
        internal static void CommandMenuInit()
        {
            ...
            PluginBase.SetCommand(0, "Info", myMenuFunction, new ShortcutKey(false, false, false, Keys.None));
            PluginBase.SetCommand(1, "Open Repository", myDockableDialog); idMyDlg = 1;
        }
